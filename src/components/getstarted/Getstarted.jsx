  ...
  return (
    ...
    <div className="flex h-[17rem] bg-black justify-between max-w-[90rem]   w-[90%] px-4 xl:px-12 md:px-12 2xl:px-12 rounded-xl  ">
        <div className="flex flex-col gap-6 justify-center xl:w-[35rem] 2xl:w-[35rem]  md:w-[35rem] w-auto">
            ...
            <a href="https://calendly.com/dhruv-aii/15min?month=2024-02" target="_blank" rel="noreferrer" className="px-10 py-3 flex w-[14rem] items-center gap-4 text-center bg-[#34B7F1] text-[white] rounded-lg font-medium">Get in touch <img src={arrow} alt="" /></a>
        </div>
